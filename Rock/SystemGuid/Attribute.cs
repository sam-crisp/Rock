...
namespace Rock.SystemGuid
{
    ...
    public class Attribute
    {
        ...
        /// <summary>
        /// Giving Journey - Current <see cref="Rock.Utility.Settings.GivingAnalytics.GivingJourneyStage">Giving Journey Stage</see>
        /// </summary>
        public const string PERSON_GIVING_CURRENT_GIVING_JOURNEY_STAGE = "13C55AEA-6D88-4470-B3AE-EE5138F044DF";

        /// <summary>
        /// Giving Journey - Previous <see cref="Rock.Utility.Settings.GivingAnalytics.GivingJourneyStage">Giving Journey Stage</see>
        /// </summary>
        public const string PERSON_GIVING_PREVIOUS_GIVING_JOURNEY_STAGE = "B35CE867-6017-484E-9EC7-AEB93CD4B2D8";

        /// <summary>
        /// Giving Journey - Change Date of <see cref="Rock.Utility.Settings.GivingAnalytics.GivingJourneyStage">Giving Journey Stage</see>
        /// </summary>
