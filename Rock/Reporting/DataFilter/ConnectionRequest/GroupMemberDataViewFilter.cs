...
namespace Rock.Reporting.DataFilter.ConnectionRequest
{
    ...
    public class GroupMemberDataViewFilter : DataFilterComponent, IRelatedChildDataView
    {
        ...
        {
            return "Group Member - matched to the Requester";
        }
...
function ()
{    
    var result = 'Group Member - matched to the Requestor';
...
";
        ...
        public override string FormatSelection( Type entityType, string selection )
        {
            ...
            using ( var context = new RockContext() )
            {
                ...
                result = string.Format( "Group Member - matched to the Requestor \"{0}\"", dataView != null ? dataView.ToString() : string.Empty );
            }
        ...
        public override Expression GetExpression( Type entityType, IService serviceInstance, ParameterExpression parameterExpression, string selection )
        {
            ...
            if ( dataView != null )
            {
                groupMemberQry = DataComponentSettingsHelper.FilterByDataView( groupMemberQry, dataView, groupMemberService );
            }

            var personKeys = groupMemberQry.Select( x => x.PersonId );
        ...
        public override Control[] CreateChildControls( Type entityType, FilterField filterControl )
        {
            ...
            dvpDataView.Label = "Group Member from Data View";
            dvpDataView.Help = "A Data View that filters the Group Member included in the result.";
            filterControl.Controls.Add( dvpDataView );

            // Populate the Data View Picker
            int entityTypeId = EntityTypeCache.Get( typeof( Model.GroupMember ) ).Id;
