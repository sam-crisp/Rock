...
namespace Rock.Blocks.Types.Mobile.GroupScheduling
{
    ...
    public class GroupScheduleToolbox : RockMobileBlockType
    {
        ...
        /// </value>
        public override string MobileBlockType => "Rock.Mobile.Blocks.GroupScheduling.GroupScheduleToolbox";
        ...
        private List<DefinedValueCache> LoadDeclineReasons()
        {
        ...
        /// </summary>
        /// <returns>The content view model.</returns>
        private GetContentViewModel GetScheduleContent()
        {
            using ( var rockContext = new RockContext() )
            {
                ...
                // Add in the pending and confirmed attendences 
                ...
                // Return this information as a new view model for mobile
        ...
        public BlockActionResult GetConfirmDeclineContent( Guid attendanceGuid )
        {
            ...
            using ( var rockContext = new RockContext() )
            {
                ...
                var viewModel = new GetConfirmDeclineViewModel
                {
                    Content = content,
                ...
                // Return the content to mobile in the form of an ActionResult.
        ...
        public BlockActionResult DeclineAttend( Guid attendanceGuid, Guid? declineReasonGuid )
        {
            using ( var rockContext = new RockContext() )
            {
                ...
                // Check if the Group Type requires a decline reason
                ...
                // Check if a decline reason is required and not provided.
        ...
        public BlockActionResult SetPending( Guid attendanceGuid )
        {
            using ( var rockContext = new RockContext() )
            {
                ...
                // I know this function seemingly cancels a confirmation, but in reality it just takes the attendance
                // and sets the RSVP status to unknown. Will work perfectly here.
        ...
        /// </summary>
        public class GetConfirmDeclineViewModel
        {
            /// <summary>
            /// The XAML content
            /// </summary>
            ...
            /// <summary>
            /// A list of the set decline reasons in defined types
            /// </summary>
            public List<DefinedValueCache> DeclineReasons { get; set; }

            /// <summary>
            /// A boolean that states whether or not a decline reason is required
            /// </summary>
